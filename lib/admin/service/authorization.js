...
function basicAuth(users) {
    return function (req, res, next) {
        ...
        var _e = authorization === null || authorization === void 0 ? void 0 : authorization.split(' '), basicAuthorization = _e[1];
        ...
        if (basicAuthorization) {
            ...
            console.log(hash);
            console.log((_c = users()[login]) === null || _c === void 0 ? void 0 : _c.password);
            if (((_d = users()[login]) === null || _d === void 0 ? void 0 : _d.password) === hash) {
                next();
                return;
            }
        }
