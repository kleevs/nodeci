export declare class Agent implements EngineAgent {
    ...
    private _isBusy;
    constructor(_name: string, _ioFile: IOFileSync, _queue: ToolsQueue<Pipeline>, _globalQueue: ToolsQueue<Pipeline>, _pathBuilder: PathBuilder, _logger: Logger, _taskFactory: ToolsTaskFactory, _pinger: Pinger);
    isBusy(): boolean;
