...
var Agent = /** @class */ (function () {
    function Agent(_name, _ioFile, _queue, _globalQueue, _pathBuilder, _logger, _taskFactory, _pinger) {
        this._name = _name;
    ...
    Agent.prototype.build = function (config) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var workFolder, id, build, tasks, context, taskname, task, _a, _b, _i, i, e_1;
            var _this = this;
            return tslib_1.__generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        workFolder = "./.nodeci/work";
                        id = this.findFreeFolderName(workFolder);
