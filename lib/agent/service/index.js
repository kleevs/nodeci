...
function start(host, name, currentPath) {
    ...
    var logger = function (id, pipeline, msg) {
        lognumber.length++;
        socket.emit('log', { id: id, pipeline: pipeline, index: lognumber.length, message: (msg === null || msg === void 0 ? void 0 : msg.replace(/\r?\n$/gi, '').replace(/^\r?\n/gi, '')) || '' });
    };
        ...
        return tslib_1.__generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    log = function (msg) { return (msg === null || msg === void 0 ? void 0 : msg.toString()) && logger(id, build.name, msg.toString()); };
                    log("pipeline " + name);
                    _d.label = 1;
                case 1:
                    _d.trys.push([1, 6, , 7]);
